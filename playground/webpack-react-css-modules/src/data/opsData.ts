...
export const stages: PipelineStage[] = [
  {
    ...
    health: 'stable',
    tasks: [
      { title: 'CSS Modules import scan', owner: 'Webpack adapter', meta: 'safe selectors', priority: 'high' },
...
export const rules: RuleCard[] = [
  ...
  },
  {
    ...
    level: 'pass',
    summary: '多个 entry 与 lazy module 最终写入同一个 static/css/semantic-atomic.css。'
  },
  {
    title: 'Native preprocessors',
    level: 'pass',
    summary: 'Webpack 原生 loader pipeline 处理 Sass/Less partial、modules tokens 与资源 URL。'
  }
];
...
export const debugGroups: DebugTokenGroup[] = [
  ...
  },
  {
    ...
    note: 'Less partial 与 additionalData 经 Webpack 编译后，safe declarations 继续增强为 atomic classes。'
  },
  {
    label: 'Metric card',
    tokenKey: 'metricCard',
...
export const artifactChecks: ArtifactCheck[] = [
  { label: 'Semantic HTML link', value: 'static/css/semantic-atomic.css', status: 'pass' },
  { label: 'Semantic atomic asset', value: 'static/css/semantic-atomic.css', status: 'pass' },
...
export const scenarioNotes: ScenarioNote[] = [
  {
    title: 'Route shell',
    detail: 'hash route 改变 React view，独立 inspector entry 观察 Webpack 多入口与 lazy chunk。',
    tone: 'info'
  },
  {
    title: 'CSS reuse',
  ...
  },
  {
    ...
    detail: '真实业务模块混用 CSS、SCSS 与 Less，Webpack loader pipeline 负责预处理和资源，GSS 只消费 scoped CSS 与 tokens。',
    tone: 'success'
  }
];
