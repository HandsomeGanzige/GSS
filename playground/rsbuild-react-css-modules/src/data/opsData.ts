...
export const stages: PipelineStage[] = [
  {
    ...
    health: 'stable',
    tasks: [
      { title: 'CSS Modules import scan', owner: 'Rsbuild adapter', meta: 'safe selectors', priority: 'high' },
...
export const rules: RuleCard[] = [
  ...
  },
  {
    ...
    level: 'pass',
    summary: 'Rsbuild/Rspack 原生处理 Sass/Less partial、modules tokens 与资源 URL。'
  }
];
...
export const debugGroups: DebugTokenGroup[] = [
  ...
  },
  {
    ...
    note: 'Less partial 与 additionalData 经 Rsbuild 编译后，safe declarations 继续增强为 atomic classes。'
  },
  {
    label: 'Metric card',
    tokenKey: 'metricCard',
...
export const scenarioNotes: ScenarioNote[] = [
  {
    title: 'Route shell',
    detail: 'hash route 改变 React view，独立 inspector entry 观察 Rsbuild 多入口与 lazy chunk。',
    tone: 'info'
  },
  {
    title: 'CSS reuse',
  ...
  },
  {
    ...
    detail: '真实业务模块混用 CSS、SCSS 与 Less，Rsbuild/Rspack 负责预处理和资源，GSS 只消费 scoped CSS 与 tokens。',
    tone: 'success'
  }
];
